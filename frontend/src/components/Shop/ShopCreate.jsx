...
const ShopCreate = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      const instaShop = values.instaShop;
      ...
      newForm.append("instaShop", instaShop);
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    type="address"
                    name="instaShop"
                    onChange={formik.handleChange("instaShop")}
                    onBlur={formik.handleBlur("instaShop")}
                    value={formik.values.instaShop}
                    className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                  />
                  <div className="text-red-500 text-xs">
                    {formik.touched.instaShop && formik.errors.instaShop}
                  </div>
                </div>
              </div>
